...
| 3 | `core-text` | 2026-08-08 | swept — CLAUDE.md called `locate`'s tiers a three-step chain when tiers 1 and 2 are alternatives gated on context; `untrusted` was missing from both the test-coverage sentence and the module list; one unreachable char-boundary loop dropped from `Stripped::offset_of` | #17 |
| 4 | `store` | — | — | — |
| 5 | `config-theme` | — | — | — |
| 6 | `ui-reading` | — | — | — |
| 7 | `agent` | — | — | — |
