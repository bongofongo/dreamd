...
| 13 | `ui-agent` | — | skipped 2026-08-18 and 2026-08-19 — the same three upkeep PRs are open both nights (#24, #25, #26), at the backlog cap; no sweep run either night, so **last swept** stays empty and `ui-agent` is still the area due. The rotation is stalled until one of the three is reviewed | — |
| 14 | `perf-harness` | — | — | — |
| 15 | `ui-style` | — | — | — |
