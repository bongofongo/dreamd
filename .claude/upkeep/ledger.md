...
| 13 | `ui-agent` | — | skipped six nights running, 2026-08-18 through 2026-08-23 — the same three upkeep PRs are open every night (#24, #25, #26), at the backlog cap, and not one has a comment, a review or a push since it was opened; #24 is eight days old. No sweep run any night, so **last swept** stays empty and `ui-agent` is still the area due. The rotation is stalled until one of the three is reviewed, and nothing this job can do will unstall it | — |
| 14 | `perf-harness` | — | — | — |
| 15 | `ui-style` | — | — | — |
