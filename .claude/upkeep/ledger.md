...
| 13 | `ui-agent` | — | skipped 2026-08-18 — three upkeep PRs already open (#24, #25, #26), at the backlog cap; no sweep run, so **last swept** stays empty and `ui-agent` is still the area due | — |
| 14 | `perf-harness` | — | — | — |
| 15 | `ui-style` | — | — | — |
