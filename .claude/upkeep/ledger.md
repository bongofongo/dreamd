...
| 13 | `ui-agent` | — | skipped sixteen nights running, 2026-08-18 through 2026-09-02 — #24, #25 and #26 sat open the whole time at the backlog cap, so no sweep ran and **last swept** stays empty. All three merged by hand on 2026-09-02 (28c60d5, df7fa87, 03989d8); the backlog is empty and `ui-agent` is still the area due, so the next night's job takes it | — |
| 14 | `perf-harness` | — | — | — |
| 15 | `ui-style` | — | — | — |
